...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { descripcion: @evento.descripcion, fecha_fin: @evento.fecha_fin, fecha_inicio: @evento.fecha_inicio, titulo: @evento.titulo }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { descripcion: @evento.descripcion, fecha_fin: @evento.fecha_fin, fecha_inicio: @evento.fecha_inicio, titulo: @evento.titulo }
    assert_redirected_to evento_path(assigns(:evento))
  end
